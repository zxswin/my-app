...
class SearchSelect extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <SelectInput selectItem={selectItem} placeholder="请选择" onClickHeader={this.onClickHeader} />

        {showDown && (
          <div className="show_data">
            <SearchInput ref={this.searchInput} value={serchText} onSearchChange={this.onSearchChange} onSearchBlur={this.onSearchBlur} />
