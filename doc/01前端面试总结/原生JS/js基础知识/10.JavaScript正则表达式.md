...
console.log(matchArr); // [ 'a', index: 0, input: 'aaabbbccc', groups: undefined ]
console.log(patten.lastIndex); // 1 下一次匹配的搜索位置
...
let uw = name1.replace(/\b(\w+)\b/g, function (word, $1) {
  // $1==== aaa
  // $1==== bbb
  // $1==== ccc
  console.log('$1====', $1);
